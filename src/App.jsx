...
function AddSectBtn({ onAdd, addLoading }) {
  ...
  return (
    <div ref={ref} style={{ position: 'fixed', top: 68, right: 20, zIndex: 80 }}>
      ...
      {open && (
        <div style={{ position: 'absolute', top: 'calc(100% + 8px)', right: 0, zIndex: 80, background: '#fff', border: `1px solid ${C.bd}`, borderRadius: 14, boxShadow: '0 8px 32px rgba(0,0,0,0.14)', padding: '14px', width: 260 }}>
