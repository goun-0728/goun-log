          ...
          {editing
            ? <>
                <input value={s.mainCopy || ''} onChange={e => onChange('mainCopy', e.target.value)}
                  ...
                  style={{ ...overlayInput, fontSize: 62, fontFamily: SERIF, marginBottom: 10 }} />
                <input value={s.subCopy || ''} onChange={e => onChange('subCopy', e.target.value)}
                  placeholder="소재 설명 (짧게)"
                  style={{ ...overlayInput, fontSize: 26 }} />
              </>
            : <>
                <div style={{ fontSize: 72, fontWeight: 900, color: '#fff', lineHeight: 1.24, wordBreak: 'keep-all', fontFamily: SERIF, textShadow: '0 3px 18px rgba(0,0,0,0.55)', marginBottom: 10 }}>{s.mainCopy}</div>
                <div style={{ fontSize: 30, color: 'rgba(255,255,255,0.86)', lineHeight: 1.68, wordBreak: 'keep-all' }}>{s.subCopy}</div>
              </>
          }
        </div>
      </div>
    ...
    <CardWrapper bg={t.bg}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
        ...
        <div style={{ padding: '68px 52px', display: 'flex', flexDirection: 'column', justifyContent: 'center', background: '#fff' }}>
          ...
          <EditText editing={editing} value={s.subCopy} onChange={v => onChange('subCopy', v)}
            style={{ fontSize: 24, color: '#666', lineHeight: 1.82, marginBottom: 36, wordBreak: 'keep-all' }} />
        ...
        <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '36px 60px 56px', pointerEvents: editing ? 'auto' : 'none' }}>
          {editing
            ? <>
                <input value={s.mainCopy || ''} onChange={e => onChange('mainCopy', e.target.value)}
                  placeholder="메인 카피"
                  style={{ ...overlayInput, fontSize: 60, fontFamily: SERIF, marginBottom: 10 }} />
                <input value={s.subCopy || ''} onChange={e => onChange('subCopy', e.target.value)}
                  placeholder="서브 카피"
                  style={{ ...overlayInput, fontSize: 26 }} />
              </>
            : <>
                <div style={{ fontSize: 68, fontWeight: 900, color: '#fff', lineHeight: 1.26, wordBreak: 'keep-all', fontFamily: SERIF, textShadow: '0 4px 24px rgba(0,0,0,0.65)', marginBottom: 12 }}>{s.mainCopy}</div>
                <div style={{ fontSize: 30, color: 'rgba(255,255,255,0.84)', lineHeight: 1.68, wordBreak: 'keep-all' }}>{s.subCopy}</div>
              </>
          }
        </div>
      </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
            <div style={{ padding: '22px 28px', borderRight: `2.5px solid ${t.ac}`, background: '#f5f5f7', textAlign: 'center' }}>
              <EditText editing={editing} value={s.compareLeft || '일반 제품'} onChange={v => onChange('compareLeft', v)}
                style={{ fontSize: 25, fontWeight: 700, color: '#999' }} />
            </div>
            <div style={{ padding: '22px 28px', background: t.ac, textAlign: 'center' }}>
              <EditText editing={editing} value={s.compareRight || ''} onChange={v => onChange('compareRight', v)}
                style={{ fontSize: 25, fontWeight: 800, color: '#fff' }} />
            </div>
          </div>
  ...
  return (
    <CardWrapper bg={t.bg}>
      ...
      <div style={{ padding: '68px 64px 0', textAlign: 'center' }}>
        ...
        <EditText editing={editing} value={s.subCopy} onChange={v => onChange('subCopy', v)}
          style={{ fontSize: 30, color: t.fg, opacity: 0.62, lineHeight: 1.75 }} />
      </div>
  ...
  return (
    <CardWrapper bg={'#fff'}>
      ...
      <div style={{ background: t.ac, padding: '64px 64px 60px', textAlign: 'center' }}>
        ...
        <EditText editing={editing} value={s.subCopy} onChange={v => onChange('subCopy', v)}
          style={{ fontSize: 30, color: 'rgba(255,255,255,0.78)', lineHeight: 1.65 }} />
      </div>
  ...
  return (
    <CardWrapper bg={t.ac}>
      ...
      <div style={{ padding: '76px 80px 96px', textAlign: 'center', background: t.ac }}>
        ...
        <EditText editing={editing} value={s.subCopy} onChange={v => onChange('subCopy', v)}
          style={{ fontSize: 32, color: 'rgba(255,255,255,0.8)', lineHeight: 1.78, wordBreak: 'keep-all' }} />
      </div>
  ...
  return (
    <CardWrapper bg="#fff">
      ...
      <div style={{ padding: '52px 64px 36px', textAlign: 'center', borderBottom: '2.5px solid #111' }}>
        ...
        {(s.subCopy || editing) && (
          <EditText editing={editing} value={s.subCopy} onChange={v => onChange('subCopy', v)}
            style={{ fontSize: 24, color: '#888', lineHeight: 1.65 }} />
        )}
      </div>
